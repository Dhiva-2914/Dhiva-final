    ...
    <div className="w-full flex flex-col items-start relative">
      ...
      {pendingTranscript ? (
        ...
        <>
          ...
          <button
            type="button"
            className={`ml-2 px-2 py-2 rounded-lg border border-gray-300 flex items-center justify-center ${isListening ? 'bg-blue-200 text-blue-700' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'} ${buttonClassName}`}
